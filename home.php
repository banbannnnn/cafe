...
.icons a {
  ...
  background-color: #D2A19F; /* matching the theme pink */
  width: 40px;
  height: 40px;
  border-radius: 50%; /* circle shape */
  box-shadow: 0 4px 8px rgba(210, 161, 159, 0.5);
...
<body>
  ...
  <header>
   ...
   <div class="icons">
    <!-- New Track Order icon next to profile -->
  <a href="orders.php" title="Track Order">
    <i class='bx bx-package'></i>  <!-- package icon from Boxicons -->
  </a>
  <a href="profile.php" title="Profile"><i class='bx bx-user'></i></a>
...
<section class="video-section">
  <div class="video-container">
    ...
    <div class="video-text">
      ...
      <a href="aboutus.php" class="learn-btn">Learn More</a>
    </div>
...
<section class="signature-section">
    <div class="signature-container">
      ...
      <div class="signature-text">
        ...
        <a href="menu.php" class="signature-button">Explore Our Menu</a>
      </div>
    </div>
  </section>
